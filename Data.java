...
public class Data {
	...
	public Data initialize() {
	    ...
	    MeetingTime meetingTime3 = new MeetingTime("MT3", "TH 09:00 - 10:30");
	    MeetingTime meetingTime4 = new MeetingTime("MT4", "TH 10:30 - 12:00");
	    ...
	    Instructor instructor3 = new Instructor("I3", "Mr. Steve Day");
	    ...
	    Course course3 = new Course("C3", "462K", new ArrayList<Instructor>(Arrays.asList(instructor1, instructor3, instructor4)), 30);
	    ...
	    depts.forEach(dept -> numberOfClasses += dept.getCourses().size());
